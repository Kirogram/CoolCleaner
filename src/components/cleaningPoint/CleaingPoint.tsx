...
export function CleaingPoint() {
    return (
        <div className="padding-item-default">
            <Text text="쿨청소꾼은 청소에 진심 입니다" className="text-align_center font24 bold"/>
            <Text text="검증된 청소 달인들로 구성되어 있습니다" className="text-align_center padding_bottom_20"/>
            <div>
